 ...
 */
public class ClassifierTreeMod implements Drawable, Serializable, RevisionHandler, CapabilitiesHandler {
  ...
  /** References to sons. */
  protected ClassifierTreeMod[] m_sons;
  ...
  public ClassifierTreeMod[] getSons() {
    return m_sons;
  }
   ...
   * Constructor.
   */
  public ClassifierTreeMod(ModelSelection toSelectLocModel) {
  ...
  public void buildTree(Instances data, boolean keepData) throws Exception {
    ...
    if (m_localModel.numSubsets() > 1) {
      ...
      data = null;
      m_sons = new ClassifierTreeMod[m_localModel.numSubsets()];
  ...
  public final void cleanup(Instances justHeaderInfo) {
    ...
    m_test = null;
    if (!m_isLeaf) {
      for (ClassifierTreeMod m_son : m_sons) {
  ...
  public StringBuffer[] toSource(String className) throws Exception {
    ...
    if (m_isLeaf) {
      ...
      long printID = ClassifierTreeMod.nextID();
   ...
   * @throws Exception if something goes wrong
   */
  protected ClassifierTreeMod getNewTree(Instances data) throws Exception {

    ClassifierTreeMod newTree = new ClassifierTreeMod(m_toSelectModel);
   ...
   * @throws Exception if something goes wrong
   */
  protected ClassifierTreeMod getNewTree(Instances train, Instances test)
    throws Exception {
   ...
   * Method just exists to make program easier to read.
   */
  private ClassifierTreeMod son(int index) {
  ...
  public double[] getMembershipValues(Instance instance) throws Exception {
    ...
    Queue<ClassifierTreeMod> queueOfNodes = new LinkedList<ClassifierTreeMod>();
    ...
    while (!queueOfNodes.isEmpty()) {
      ...
      ClassifierTreeMod node = queueOfNodes.poll();
